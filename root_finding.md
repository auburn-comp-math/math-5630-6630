...
\end{aligned}
$$
which moves the new point to the other side of the root by almost reflection. The next bracket becomes $[c, c']$. Therefore the sequence generated by Illinois method will eventually become 
```
